...
//    dialogView.layer.transform = CATransform3DMakeScale(1.3f, 1.3f, 1.0);
    CGAffineTransform dlgTransform = CGAffineTransformIdentity;
    ...
    // Attached to the top most window (make sure we are using the right orientation):
        ...
        dlgTransform = CGAffineTransformMakeRotation(dlgRadian);
        self.dialogView.transform = CGAffineTransformScale(dlgTransform, 1.3, 1.3);
        
//        UIInterfaceOrientation interfaceOrientation = [[UIApplication sharedApplication] statusBarOrientation];
//        CGAffineTransform dialogTransform = self.dialogView.transform;
//        switch (interfaceOrientation) {
//            case UIInterfaceOrientationLandscapeLeft:
//                self.transform = CGAffineTransformMakeRotation(M_PI * 270.0 / 180.0);
//                dialogTransform = CGAffineTransformMakeRotation(M_PI * 90.0 / 180.0);
//                break;
//                
//            case UIInterfaceOrientationLandscapeRight:
//                self.transform = CGAffineTransformMakeRotation(M_PI * 90.0 / 180.0);
//                dialogTransform = CGAffineTransformMakeRotation(M_PI * 270.0 / 180.0);
//                break;
//
//            case UIInterfaceOrientationPortraitUpsideDown:
//                self.transform = CGAffineTransformMakeRotation(M_PI * 180.0 / 180.0);
//                dialogTransform = CGAffineTransformMakeRotation(M_PI * 180.0 / 180.0);
//                break;
//
//            default:
//                break;
//        }
//        self.dialogView.transform = dialogTransform;
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionCurveEaseInOut
					 animations:^{
                         ...
                         dialogView.transform = CGAffineTransformScale(dlgTransform, 1.f, 1.f);
                         //dialogView.layer.transform = CATransform3DMakeScale(1, 1, 1);
                         //CATransform3DScale(dialogView.layer.transform, 1, 1, 1);
					 }
					 completion:NULL
     ];
}
...
- (void)deviceOrientationDidChange: (NSNotification *)notification
{
    ...
    UIDeviceOrientation interfaceOrientation = device.orientation;
    
//    CGFloat startRotation = [[self valueForKeyPath:@"layer.transform.rotation.z"] floatValue];

//    startRotation = [[self.dialogView valueForKeyPath:@"layer.transform.rotation.z"] floatValue];
...
//    }
    ...
    if (UIDeviceOrientationIsLandscape(interfaceOrientation)) {
        ...
        if (interfaceOrientation == UIDeviceOrientationPortraitUpsideDown) { radians = (CGFloat)M_PI; }
        else { radians = 0; }
        dlgRadian = radians;
    }
    
    CGAffineTransform rotation = CGAffineTransformMakeRotation(dlgRadian);//-startRotation + dlgRadian);
